...
def make_squarethumb(thumbnail, output):
    """Convert thumbnail to round thumbnail"""
    # https://stackoverflow.com/a/52177551
    original_thumb = Image.open(thumbnail)
    roundthumb = _crop_to_round(original_thumb)
    roundthumb.thumbnail((TG_THUMB_MAX_LENGTH, TG_THUMB_MAX_LENGTH),
                          Image.ANTIALIAS)
    roundthumb.save(output)
...
app.start()
print('>>> BOT STARTED @by @vaasukionfire7966')
idle()
app.stop()
print('\n>>> BOT STOPPED @by @vaasukionfire7966')
